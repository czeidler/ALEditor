...
public:
	...
	status_t			AddMessage(const char *name, const BMessage* value);
	...
	status_t			FindMessage(const char *name, BMessage* value, int32 index = 0) const;
	...
	status_t			ReplaceMessage(const char *name, BMessage* value, int32 index = 0);
