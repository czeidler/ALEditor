...
int32
add_parg_int8(void *args, const char *name, int8 arg)
{
	PArgs *pargs = static_cast<PArgs*>(args);
	if (!pargs)
		return B_BAD_DATA;
...
int32
add_parg_int16(void *args, const char *name, int16 arg)
{
	PArgs *pargs = static_cast<PArgs*>(args);
	if (!pargs)
		return B_BAD_DATA;
...
int32
add_parg_int32(void *args, const char *name, int32 arg)
{
	PArgs *pargs = static_cast<PArgs*>(args);
	if (!pargs)
		return B_BAD_DATA;
...
int32
add_parg_int64(void *args, const char *name, int64 arg)
{
	PArgs *pargs = static_cast<PArgs*>(args);
	if (!pargs)
		return B_BAD_DATA;
...
int32
find_parg(void *args, const char *name, int32 type, const void **data,
			int32 *size)
{
	PArgs *pargs = static_cast<PArgs*>(args);
	if (!pargs)
...
int32
find_parg_index(void *args, const char *name, int32 type, const void **data,
			int32 *size, int32 index)
{
	PArgs *pargs = static_cast<PArgs*>(args);
	if (!pargs)
		return B_BAD_DATA;
...
int32
find_parg_int8(void *args, const char *name, int8 *out)
{
	PArgs *pargs = static_cast<PArgs*>(args);
	if (!pargs)
		return B_BAD_DATA;
...
int32
find_parg_int8_index(void *args, const char *name, int8 *out, int32 index)
{
	PArgs *pargs = static_cast<PArgs*>(args);
	if (!pargs)
		return B_BAD_DATA;
...
int32
find_parg_int16(void *args, const char *name, int16 *out)
{
	PArgs *pargs = static_cast<PArgs*>(args);
	if (!pargs)
		return B_BAD_DATA;
...
int32
find_parg_int16_index(void *args, const char *name, int16 *out, int32 index)
{
	PArgs *pargs = static_cast<PArgs*>(args);
	if (!pargs)
		return B_BAD_DATA;
...
int32
find_parg_int32(void *args, const char *name, int32 *out)
{
	PArgs *pargs = static_cast<PArgs*>(args);
	if (!pargs)
		return B_BAD_DATA;
...
int32
find_parg_int32_index(void *args, const char *name, int32 *out, int32 index)
{
	PArgs *pargs = static_cast<PArgs*>(args);
	if (!pargs)
		return B_BAD_DATA;
...
int32
find_parg_int64(void *args, const char *name, int64 *out)
{
	PArgs *pargs = static_cast<PArgs*>(args);
	if (!pargs)
		return B_BAD_DATA;
...
int32
find_parg_int64_index(void *args, const char *name, int64 *out, int32 index)
{
	PArgs *pargs = static_cast<PArgs*>(args);
	if (!pargs)
		return B_BAD_DATA;
...
int32
find_parg_float_index(void *args, const char *name, float *out, int32 index)
{
	PArgs *pargs = static_cast<PArgs*>(args);
	if (!pargs)
		return B_BAD_DATA;
...
int32
find_parg_double_index(void *args, const char *name, double *out, int32 index)
{
	PArgs *pargs = static_cast<PArgs*>(args);
	if (!pargs)
		return B_BAD_DATA;
...
int32
find_parg_bool_index(void *args, const char *name, bool *out, int32 index)
{
	PArgs *pargs = static_cast<PArgs*>(args);
	if (!pargs)
		return B_BAD_DATA;
...
int32
find_parg_char_index(void *args, const char *name, char *out, int32 index)
{
	PArgs *pargs = static_cast<PArgs*>(args);
	if (!pargs)
		return B_BAD_DATA;
...
int32
find_parg_string_index(void *args, const char *name, const char **arg, int32 index)
{
	PArgs *pargs = static_cast<PArgs*>(args);
	if (!pargs)
		return B_BAD_DATA;
...
find_parg_point(void *args, const char *name, float *x, float *y)
{
	...
	BPoint pt;
	status_t status_t = pargs->FindPoint(name, &pt);
	*x = pt.x;
	*y = pt.y;
					...
					int32 index)
{
	...
	BPoint pt;
	status_t status_t = pargs->FindPoint(name, &pt, index);
									...
									float *top, float *right, float *bottom)
{
	...
	BRect r;
	status_t status_t = pargs->FindRect(name, &r);
					...
					float *top, float *right, float *bottom, int32 index)
{
	...
	BRect r;
	status_t status_t = pargs->FindRect(name, &r, index);
				...
				unsigned char *green, unsigned char *blue, unsigned char *alpha)
{
	...
	rgb_color c;
	status_t status_t = pargs->FindColor(name, &c);
				...
				int32 index)
{
	...
	rgb_color c;
	status_t status_t = pargs->FindColor(name, &c, index);
...
int32
find_parg_pointer_index(void *args, const char *name, void **ptr, int32 index)
{
	PArgs *pargs = static_cast<PArgs*>(args);
	if (!pargs)
		return B_BAD_DATA;
...
int32
replace_parg_char_index(void *args, const char *name, char arg, int32 index)
{
	PArgs *pargs = static_cast<PArgs*>(args);
	if (!pargs)
		return B_BAD_DATA;
...
replace_parg_rect_index(void *args, const char *name, float left, float top,
				float right, float bottom, int32 index)
{
	PArgs *pargs = static_cast<PArgs*>(args);
	if (!pargs)
		return B_BAD_DATA;
...
int32
replace_parg_point_index(void *args, const char *name, float x, float y, int32 index)
{
	PArgs *pargs = static_cast<PArgs*>(args);
	if (!pargs)
		return B_BAD_DATA;
...
int32
replace_parg_string_index(void *args, const char *name, const char *arg, int32 index)
{
	PArgs *pargs = static_cast<PArgs*>(args);
	if (!pargs)
		return B_BAD_DATA;
...
int32
replace_parg_int8(void *args, const char *name, int8 arg)
{
	PArgs *pargs = static_cast<PArgs*>(args);
	if (!pargs)
		return B_BAD_DATA;
...
int32
replace_parg_int8_index(void *args, const char *name, int8 arg, int32 index)
{
	PArgs *pargs = static_cast<PArgs*>(args);
	if (!pargs)
		return B_BAD_DATA;
...
int32
replace_parg_int16(void *args, const char *name, int16 arg)
{
	PArgs *pargs = static_cast<PArgs*>(args);
	if (!pargs)
		return B_BAD_DATA;
...
int32
replace_parg_int16_index(void *args, const char *name, int16 arg, int32 index)
{
	PArgs *pargs = static_cast<PArgs*>(args);
	if (!pargs)
		return B_BAD_DATA;
...
int32
replace_parg_int32(void *args, const char *name, int32 arg)
{
	PArgs *pargs = static_cast<PArgs*>(args);
	if (!pargs)
		return B_BAD_DATA;
...
int32
replace_parg_int32_index(void *args, const char *name, int32 arg, int32 index)
{
	PArgs *pargs = static_cast<PArgs*>(args);
	if (!pargs)
		return B_BAD_DATA;
...
int32
replace_parg_int64(void *args, const char *name, int64 arg)
{
	PArgs *pargs = static_cast<PArgs*>(args);
	if (!pargs)
		return B_BAD_DATA;
...
int32
replace_parg_int64_index(void *args, const char *name, int64 arg, int32 index)
{
	PArgs *pargs = static_cast<PArgs*>(args);
	if (!pargs)
		return B_BAD_DATA;
...
int32
replace_parg_bool_index(void *args, const char *name, bool arg, int32 index)
{
	PArgs *pargs = static_cast<PArgs*>(args);
	if (!pargs)
		return B_BAD_DATA;
...
int32
replace_parg_float_index(void *args, const char *name, float arg, int32 index)
{
	PArgs *pargs = static_cast<PArgs*>(args);
	if (!pargs)
		return B_BAD_DATA;
...
int32
replace_parg_double_index(void *args, const char *name, double arg, int32 index)
{
	PArgs *pargs = static_cast<PArgs*>(args);
	if (!pargs)
		return B_BAD_DATA;
...
int32
replace_parg_pointer_index(void *args, const char *name, void *ptr, int32 index)
{
	PArgs *pargs = static_cast<PArgs*>(args);
	if (!pargs)
		return B_BAD_DATA;
...
int32
replace_parg_list_index(void *args, const char *name, void *list, int32 index)
{
	PArgs *pargs = static_cast<PArgs*>(args);
	if (!pargs)
		return B_BAD_DATA;
